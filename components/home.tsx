...
const cards = [
  { name: "Active users", icon: UserGroupIcon, amount: "1428" },
  {
    name: "Active service providers",
...
const transactions = [
  {
    id: 1,
    name: "Refund request for a service",
    href: "#",
    author: "Ahmed Sameh",
    status: "resolved",
    date: "July 11, 2020",
  ...
  {
    id: 2,
    name: "I forgot my account password",
    href: "#",
    author: "Michael Fawzy",
    date: "2d ago",
  ...
  {
    id: 3,
    name: "App crashing on iphone 13",
    href: "#",
    author: "Aya Mohamed",
    date: "3d ago",
