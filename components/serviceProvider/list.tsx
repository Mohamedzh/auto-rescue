...
import Heading from "../users/heading";
...
const issues = [
  ...
  {
    id: 3,
    title: "Funds can't be withdrawn",
    href: "#",
    author: { name: "Castrol" },
    body: " cras tincidunt lobortis feugiat vivamus at augue eget arcu dictum    varius duis at consectetur lorem donec massa sapien faucibus et    molestie ac feugiat sed lectus",
    date: "3d ago",
  ...
  {
    id: 4,
    title: "How to cancel a service after client has ordered it?",
    href: "#",
    author: { name: "Amin auto" },
    body: " cras tincidunt lobortis feugiat vivamus at augue eget arcu dictum    varius duis at consectetur lorem donec massa sapien faucibus et    molestie ac feugiat sed lectus",
    date: "5d ago",
  ...
  {
    id: 5,
    title: "Fake negative reviews",
    href: "#",
    author: { name: "Toyo tires" },
    body: " cras tincidunt lobortis feugiat vivamus at augue eget arcu dictum    varius duis at consectetur lorem donec massa sapien faucibus et    molestie ac feugiat sed lectus",
    date: "5d ago",
...
export default function List() {
  ...
  const header = "Service providers support tickets";
  return (
    <div>
